...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.the_switchStyle);
    }
    ...
    public Switch(Context context, AttributeSet attrs, int defStyle) {
        ...
        mThumbDrawable = a.getDrawable(R.styleable.Switch_the_thumb);
        mTrackDrawable = a.getDrawable(R.styleable.Switch_the_track);
        mTextOn = a.getText(R.styleable.Switch_the_textOn);
        mTextOff = a.getText(R.styleable.Switch_the_textOff);
        mThumbTextPadding = a.getDimensionPixelSize(R.styleable.Switch_the_thumbTextPadding, 0);
        mSwitchMinWidth = a.getDimensionPixelSize(R.styleable.Switch_the_switchMinWidth, 0);
        mSwitchPadding = a.getDimensionPixelSize(R.styleable.Switch_the_switchPadding, 0);

        final int appearance = a.getResourceId(R.styleable.Switch_the_switchTextAppearance, 0);
        if (appearance != 0) {
     ...
     * variants, so you may need to use {@link #setSwitchTypeface(android.graphics.Typeface, int)} to get the appearance
